    ...
    <section class="content">
        <div class="box box-form">
            <div class="box-header">
                <h3 class="box-title">Core Service Page</h3>
            </div>
            <!-- /.box-header -->
            <form action="{{ url('_admin_/page/core_service') }}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="box-body">
                    <div class='row'>
                        <div class='col-md-12'>
                        ...
                        <div class='col-md-12'>
                            <div class='form-group'>
                                ...
                                <input class="form-control" id="description" name="description" type="text"
                                       value="{{ empty(old('description'))? isset($page)?$page->description:''  : old('description') }}"   placeholder="Type Short Description Core Service This Page"/>
                            </div>
                        </div>
                        <div class='col-md-12'>
                            <div class='form-group'>
