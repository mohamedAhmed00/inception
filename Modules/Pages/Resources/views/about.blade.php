...
@section('content')
    ...
    <section class="content">
        <div class="box box-form">
            ...
            <!-- /.box-header -->
            <form action="{{ url('_admin_/page/about') }}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="box-body">
                    <div class='row'>
                        <div class='col-md-12'>
                        ...
                        <div class='col-md-12'>
                            <div class='form-group'>
                                ...
                                <input class="form-control" id="description" name="description" type="text"
                                       value="{{ empty(old('description'))? isset($page)?$page->description:''  : old('description') }}"   placeholder="Type Short Description About This Page"/>
                            </div>
                        </div>
                        <div class='col-md-12'>
                            <div class='form-group'>
                        ...
                        <div class="col-md-12">
                            <div class='form-group'>
                                ...
                                <div class="col-xs-6">
                                    ...
                                    <img class="member-online img-rounded" style="width: 100px;height: 100px;" src="{{ asset(!empty($page->Image->image)?$page->Image->image:'') }}" alt="About Image">
                                </div>
                            </div>
                        </div>
