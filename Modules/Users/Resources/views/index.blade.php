                        ...
                        <table id="payments" class="table responsive">
                            ...
                            @foreach($users as $user)
                                <tr>
                                    ...
                                    <td class="text-center"><a href="{{ route('user.edit',$user->id) }}" class="btn btn-success btn-sm"><i class="fa fa-edit text-capitalize"> Edit </i></a></td>
                                        ...
                                        <div class="slab">
                                            <div class="controls">
                                                ...
                                                <div class="confirm">
                                                    ...
                                                    <a href="{{ route('user.delete',$user->id) }}" class="btn btn-danger btn-sm"><i class="fa fa-remove text-capitalize"> Yes </i></a>
                                                </div>
                                            </div>
                                        </div>
                                    </td>
